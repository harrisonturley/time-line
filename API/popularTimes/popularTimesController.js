...
function startPythonProcess(id){
    ...
    return new Promise(function(success, nosuccess) {
        ...
        //remember to un hard code id
        const pythonProcess = spawn('python',["C:/Users/victo/Documents/year3/CPEN321/time-line repo/time-line/API/popularTimes/popularTimes.py", "ChIJSYuuSx9awokRyrrOFTGg0GY"]);
        pythonProcess.stdout.on('data', (data) => {
            console.log("in node js function, data is: "+ data.toString());
            success(data);
        });
